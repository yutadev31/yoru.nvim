...
local C = {
  ...
  fg = U.hsl(0, 0, 95),
  bg = U.hsl(240, 20, 18),
  bg_dark = U.hsl(240, 20, 15),
  bg_light = U.hsl(240, 20, 22),
  selection = U.hsl(240, 20, 30),
  white = U.hsl(240, 20, 85),
  black = U.hsl(240, 20, 42),
  red = U.hsl(0, 100, 80),
  orange = U.hsl(22, 100, 80),
  yellow = U.hsl(44, 100, 80),
  green = U.hsl(132, 100, 80),
  cyan = U.hsl(180, 100, 80),
  blue = U.hsl(225, 100, 80),
  purple = U.hsl(280, 100, 80),
}
